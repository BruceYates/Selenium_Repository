...
import seleniumManager.SeleniumManager;
import seleniumManager.TheSeleniumManager;
...
public class SeleniumSimplifiedTest {
	...
	static public void startServer() throws IOException{
		sm = TheSeleniumManager.getSeleniumManager().start("http://www-qa.bestfriends.org");
	...
	private void captureScreenShots(String screenShotsFolder, 
		...
		// since captureScreenshot takes the screen, we should maximize the 
